...
class Toolbar extends React.Component {
  ...
  // closeMenu(event) {
  //   if (!this.dropdownMenu.contains(event.currentTarget)) {
    ...
    const display = this.props.currentUser ? (
      ...
      >
        ...
        <ul className="account-dropdown--options">
          ...
          <p class-name="account-dropdown--option">My Orders</p>
    ...
    return (
      <section className="toolbar" >
        ...
        <ul className="profile-icons">
            <li className="icons">
              <button onClick={this.showMenu}><i className="fa fa-user" id="account-dropdown-button"></i></button>
